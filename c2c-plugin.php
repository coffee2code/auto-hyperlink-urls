...
if ( ! class_exists( 'c2c_AutoHyperlinkURLs_Plugin_040' ) ) :

abstract class c2c_AutoHyperlinkURLs_Plugin_040 {
...
//				echo '<div class="hr">&nbsp;</div>' . "\n";
	...
	public function options_page() {
		...
		echo "<div class='wrap'>\n";
		echo "<div class='icon32' style='width:44px;'><img src='{$logo}' alt='" . esc_attr__( 'A plugin by coffee2code', 'auto-hyperlink-urls' ) . "' /><br /></div>\n";
